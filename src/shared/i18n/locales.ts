...
const es_419: Messages = {
  ...
  'files.title': 'Guiones',
  'files.empty': 'No hay archivos .fountain o .txt ni subcarpetas en esta carpeta.',
...
const de_DE: Messages = {
  ...
  'files.empty': 'Keine .fountain- oder .txt-Dateien und keine Unterordner in diesem Ordner.',
...
const fr_FR: Messages = {
  ...
  'files.empty': 'Aucun fichier .fountain ou .txt, ni sous-dossier, dans ce dossier.',
...
const it_IT: Messages = {
  ...
  'files.empty': 'Nessun file .fountain o .txt e nessuna sottocartella in questa cartella.',
